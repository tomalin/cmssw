...
namespace Phase2Tracker {
 ...
 class Phase2TrackerFEDStubChannelUnpacker
  ...
  {
      public:
          Phase2TrackerFEDStubSon2SChannelUnpacker(const Phase2TrackerFEDChannel& channel) : Phase2TrackerFEDStubChannelUnpacker(channel)
          {
  ...
  {
      public:
          Phase2TrackerFEDStubPonPSChannelUnpacker(const Phase2TrackerFEDChannel& channel) : Phase2TrackerFEDStubChannelUnpacker(channel)
          {
