...
*/
  ...
  public:
    ...
    float chisquaredRphi() const {
      this->ok();
      return chisquaredRphi_;
    }
    float chisquaredRz() const {
      this->ok();
      return chisquaredRz_;
    }
    ...
    float qOverPt_bcon() const {
      this->ok();
      return qOverPt_bcon_;
    }
    float oneOver2r_bcon() const {
      this->ok();
      return oneOver2r_bcon_;
    }  // half inverse curvature of track.
    ...
    float phi0rel_bcon() const {
      this->ok();
      return phi0rel_bcon_;
    }  // measured relative to centre of sector
    float chisquaredRphi_bcon() const {
      this->ok();
      return chisquaredRphi_bcon_;
    }
    ...
    float orig_qOverPt() const {
      this->okin();
      return qOverPt_orig_;
    }
    float orig_oneOver2r() const {
      this->okin();
      return oneOver2r_orig_;
    }  // half inverse curvature of track.
    float orig_d0() const {
      this->okin();
      return d0_orig_;
    ...
    float orig_tanLambda() const {
      this->okin();
      return tanLambda_orig_;
    }
    float orig_chisquaredRphi() const {
      this->okin();
      return chisquaredRphi_orig_;
    }
    float orig_chisquaredRz() const {
      this->okin();
      return chisquaredRz_orig_;
    }
    ...
    float tp_useForAlgEff() const {
      this->okin();
      return tp_useForAlgEff_;
    }
    float tp_useForEff() const {
      this->okin();
      return tp_useForEff_;
    }
